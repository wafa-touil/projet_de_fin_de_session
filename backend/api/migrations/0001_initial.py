    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('facile', 'Facile'), ('difficile', 'Difficile')], default='facile', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('QCM', 'Choix Multiple'), ('VRAI_FAUX', 'Vrai ou Faux')], default='QCM', max_length=20)),
